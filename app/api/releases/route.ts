...
export async function POST(req: NextRequest) {
  try {
    ...
    // Check if user is a producer and get their city
    const user = await User.findById(session.user.id).select("isProducer city").populate("city", "name").lean() as any;
    ...
    // Create post in activity feed
    const cityName = user.city?.name || "Unknown";
    await Post.create({
